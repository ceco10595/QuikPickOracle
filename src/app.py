...
if st.session_state.pending_q:
    ...
    if repeat_count > 2:
        st.session_state.history.append(
            AIMessage(content="Thank you for your patience./n Please contact the QuikPick team. /nYou will need: /n1. a photo of the Service UI BasicInfo section /n2. the Jupiter PCSN. /nEnsure you mention the error code to the team")
        )
